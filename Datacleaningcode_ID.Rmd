...
allstates<-rbind(IDdatPull,DEdatPull)
...
```{r}
#Depth
vars2process <- unique(data$CharacteristicName)
Depth_params<-c("Depth, data-logger (non-ported)", "Depth", "Depth, data-logger (ported)", "Depth, bottom") #only values for depth
vars2process<-vars2process[! vars2process %in% Depth_params] #remove grab samples from list
vars2process
...
vars2process<-vars2process[! vars2process %in% Calcium_params] #remove grab samples from list
vars2process
