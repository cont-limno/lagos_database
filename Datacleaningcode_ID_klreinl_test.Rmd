...
data_silica$ResultMeasure.MeasureUnitCode[!is.na(data_silica$ResultMeasure.MeasureUnitCode)] <- "ug/l"
data_silica$DetectionQuantitationLimitMeasure.MeasureUnitCode[!is.na(data_silica$DetectionQuantitationLimitMeasure.MeasureUnitCode)] <- "ug/l"
...
data_silica$CharacteristicName<-"Nitrogen, nitrite (NO2) + nitrate (NO3)"  #set param name
```
