...
params<-c("Depth, data-logger (non-ported)", "Depth", "Depth, data-logger (ported)", "Depth, bottom", "Depth of water column")
...
vars2process
params<-c("Chlorophyll a, corrected for pheophytin", "Chlorophyll a", "Chlorophyll a, uncorrected for pheophytin", "Chlorophyll", "Chlorophyll a - Phytoplankton (suspended)", "Chlorophyll a (probe)", "Chlorophyll a (probe relative fluorescence)", "Chlorophyll a, free of pheophytin")
vars2process<-vars2process[! vars2process %in% params] #remove grab samples from list
vars2process #check if any new varables to inlcude
...
params<-c("Sulfate as SO4",
          "Sulfate as S",
          "Sulfate", "Sulfur Sulfate", "Sulfur", "Sulfur-34", "Sulfite")
vars2process<-vars2process[! vars2process %in% params] #remove grab samples from list
vars2process #che
...
vars2process
params<-c("Alkalinity, total", "Alkalinity, Carbonate as CaCO3", "Alkalinity", "Alkalinity, carbonate", "Alkalinity, Bicarbonate as CaCO3")
vars2process<-vars2process[! vars2process %in% params] #remove grab samples from list
vars2process #check if any new varables to inlcude
...
vars2process
params<-c("Microcystin", "Microcystin RR", "Microcystin LF", "Microcystins and nodularins", "Microcystis", "Microcystin LR", "Microcystin LA", "Microcystins")
vars2process<-vars2process[! vars2process %in% params] #remove grab samples from list
vars2process #check if any new varables to inlcude
