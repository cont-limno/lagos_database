...
CTdatPull<-read.csv(paste0(file.path,"CT_cleaned.csv"))
...
IAdatPull<-read.csv(paste0(file.path,"IA_cleaned.csv"))
...
ILdatPull<-read.csv(paste0(file.path,"IL_cleaned.csv"))
...
INdatPull<-read.csv(paste0(file.path,"IN_cleaned.csv"))
...
MAdatPull<-read.csv(paste0(file.path,"MA_cleaned.csv"))
...
MEdatPull<-read.csv(paste0(file.path,"ME_cleaned.csv"))
...
MIdatPull<-read.csv(paste0(file.path,"MI_cleaned.csv"))
...
MNdatPull<-read.csv(paste0(file.path,"MN_cleaned.csv"))
...
MOdatPull<-read.csv(paste0(file.path,"MO_cleaned.csv"))
...
NHdatPull<-read.csv(paste0(file.path,"NH_cleaned.csv"))
...
NJdatPull<-read.csv(paste0(file.path,"NJ_cleaned.csv"))
...
NYdatPull<-read.csv(paste0(file.path,"NY_cleaned.csv"))
...
OHdatPull<-read.csv(paste0(file.path,"OH_cleaned.csv"))
...
PAdatPull<-read.csv(paste0(file.path,"PA_cleaned.csv"))
...
RIdatPull<-read.csv(paste0(file.path,"RI_cleaned.csv"))
...
VTdatPull<-read.csv(paste0(file.path,"VT_cleaned.csv"))
...
WIdatPull<-read.csv(paste0(file.path,"WI_cleaned.csv"))
...
#checking manually and filtering for start and end dates - checked for media and submedia type - all water

#CT has no enddates
CTdatPull<-CTdatPull %>% filter(ActivityStartDate >= "1975-01-01")

#IA has no enddates past 2009
IAdatPull<-IAdatPull %>% filter(ActivityStartDate >= "1975-01-01")

#IL has end dates past 2020-11-20
ILdatPull<-ILdatPull %>% filter(ActivityStartDate >= "1975-01-01" & ActivityEndDate <= "2020-11-20")


#IN has no endates past 2020-11-20
INdatPull<-INdatPull %>% filter(ActivityStartDate >= "1975-01-01")

#MA no enddates past 2011
MAdatPull<-MAdatPull %>% filter(ActivityStartDate >= "1975-01-01")

#ME no enddates past 2015
MEdatPull<-MEdatPull %>% filter(ActivityStartDate >= "1975-01-01")

#MI has end dates past 2020-11-20
MIdatPull<-MIdatPull %>% filter(ActivityStartDate >= "1975-01-01" & ActivityEndDate <= "2020-11-20")

#MN has enddates past 2020-11-20
MNdatPull<-MNdatPull %>% filter(ActivityStartDate >= "1975-01-01"& ActivityEndDate <= "2020-11-20")

#MO no enddates past 1993
MOdatPull<-MOdatPull %>% filter(ActivityStartDate >= "1975-01-01")

#NH no enddates past 2016
NHdatPull<-NHdatPull %>% filter(ActivityStartDate >= "1975-01-01")

#NJ no enddates 
NJdatPull<-NJdatPull %>% filter(ActivityStartDate >= "1975-01-01")

#NY has enddates past 2020-11-20
NYdatPull<-NYdatPull %>% filter(ActivityStartDate >= "1975-01-01" & ActivityEndDate <= "2020-11-20")

#OH has enddates past 2020-11-20
OHdatPull<-OHdatPull %>% filter(ActivityStartDate >= "1975-01-01" & ActivityEndDate <= "2020-11-20")

#PA has enddates past 2020-11-20
PAdatPull<-PAdatPull %>% filter(ActivityStartDate >= "1975-01-01" & ActivityEndDate <= "2020-11-20")

#RI no enddates
RIdatPull<-RIdatPull %>% filter(ActivityStartDate >= "1975-01-01")

#VT no enddates past 2004
VTdatPull<-VTdatPull %>% filter(ActivityStartDate >= "1975-01-01")

#WI has enddates past 2020-11-20
WIdatPull<-WIdatPull %>% filter(ActivityStartDate >= "1975-01-01" & ActivityEndDate <= "2020-11-20")
...
COdatPull<-read.csv(paste0(file.path,"CO_alldata_1975_to_2020.csv"))
...
AZdatPull<-read.csv(paste0(file.path,"AZ_alldata_1975_to_2020.csv"))
...
ARdatPull<-read.csv(paste0(file.path,"AR_alldata_1975_to_2020.csv"))
...
ALdatPull<-read.csv(paste0(file.path,"AL_alldata_1975_to_2020.csv"))
...
WYdatPull<-read.csv(paste0(file.path,"WY_alldata_1975_to_2020.csv"))
...
KYdatPull<-read.csv(paste0(file.path,"KY_alldata_1975_to_2020.csv"))
...
NVdatPull<-read.csv(paste0(file.path,"NV_alldata_1975_to_2020.csv"))
...
OKdatPull<-read.csv(paste0(file.path,"OK_alldata_1975_to_2020.csv"))
...
WAdatPull<-read.csv(paste0(file.path,"WA_alldata_1975_to_2020.csv"))
...
KSdatPull<-read.csv(paste0(file.path,"KS_alldata_1975_to_2020.csv"))
...
TNdatPull<-read.csv(paste0(file.path,"TN_alldata_1975_to_2020.csv"))
...
CAdatPull<-read.csv(paste0(file.path,"CA_alldata_1975_to_2020.csv"))
...
FLdatPull<-read.csv(paste0(file.path,"FL_alldata_1975_to_2020.csv"))
...
GAdatPull<-read.csv(paste0(file.path,"GA_alldata_1975_to_2020.csv"))
...
LAdatPull<-read.csv(paste0(file.path,"LA_alldata_1975_to_2020.csv"))
...
MSdatPull<-read.csv(paste0(file.path,"MS_alldata_1975_to_2020.csv"))
...
MTdatPull<-read.csv(paste0(file.path,"MT_alldata_1975_to_2020.csv"))
...
NEdatPull<-read.csv(paste0(file.path,"NE_alldata_1975_to_2020.csv"))
...
NMdatPull<-read.csv(paste0(file.path,"NM_alldata_1975_to_2020.csv"))
...
NCdatPull<-read.csv(paste0(file.path,"NC_alldata_1975_to_2020.csv"))
...
NDdatPull<-read.csv(paste0(file.path,"ND_alldata_1975_to_2020.csv"))
...
ORdatPull<-read.csv(paste0(file.path,"OR_alldata_1975_to_2020.csv"))
...
SCdatPull<-read.csv(paste0(file.path,"SC_alldata_1975_to_2020.csv"))
...
SDdatPull<-read.csv(paste0(file.path,"SD_alldata_1975_to_2020.csv"))
...
TXdatPull<-read.csv(paste0(file.path,"TX_alldata_1975_to_2020.csv"))
...
UTdatPull<-read.csv(paste0(file.path,"UT_alldata_1975_to_2020.csv"))
...
#needed to convert value column to numeric

# unique(data$ResultDepthHeightMeasure.MeasureUnitCode) 
# unique(data$ResultDepthHeightMeasure.MeasureValue) 
# str(data)
# temp<-data
# temp$ResultDepthHeightMeasure.MeasureValue<-as.numeric(as.character(temp$ResultDepthHeightMeasure.MeasureValue))
# str(temp)
...
#need to make values column numeric
...
params<-c("Depth", "Depth, bottom", "Depth of water column")
...
params<-c("Depth, Secchi disk depth","Depth, Secchi disk depth (choice list)","Water transparency, Secchi disc") #values for secchi
vars2process<-vars2process[! vars2process %in% params] #remove grab samples from list
vars2process #che
...
unique(temp$ResultMeasureValue)
temp2 <- temp %>% filter(ResultMeasureValue == "148`")
data_temp$ResultMeasureValue[which(data_temp$Obs_Id %in% temp2$Obs_Id)] <- 148


temp2 <- temp %>% filter(ResultMeasureValue == "1,035")
data_temp$ResultMeasureValue[which(data_temp$Obs_Id %in% temp2$Obs_Id)] <- 1035

temp2 <- temp %>% filter(ResultMeasureValue == "1,044")
data_temp$ResultMeasureValue[which(data_temp$Obs_Id %in% temp2$Obs_Id)] <- 1044

temp2 <- temp %>% filter(ResultMeasureValue == "1,020")
data_temp$ResultMeasureValue[which(data_temp$Obs_Id %in% temp2$Obs_Id)] <- 1020

temp2 <- temp %>% filter(ResultMeasureValue == "1,021")
data_temp$ResultMeasureValue[which(data_temp$Obs_Id %in% temp2$Obs_Id)] <- 1021

temp2 <- temp %>% filter(ResultMeasureValue == "1,090")
data_temp$ResultMeasureValue[which(data_temp$Obs_Id %in% temp2$Obs_Id)] <- 1090

temp2 <- temp %>% filter(ResultMeasureValue == "1,024")
data_temp$ResultMeasureValue[which(data_temp$Obs_Id %in% temp2$Obs_Id)] <- 1024

temp2 <- temp %>% filter(ResultMeasureValue == "1,022")
data_temp$ResultMeasureValue[which(data_temp$Obs_Id %in% temp2$Obs_Id)] <- 1022

temp2 <- temp %>% filter(ResultMeasureValue == "1,031")
data_temp$ResultMeasureValue[which(data_temp$Obs_Id %in% temp2$Obs_Id)] <- 1031
...
lagos_unit <- "mg/l"
dataset_name <-"Carbon_total_organic"
...
lagos_unit <- "mg/l"
dataset_name <-"Carbon_dissolved_organic"
...
vars2process
params<-c("Microcystin", "Microcystin RR", "Microcystin LF", "Microcystins and nodularins", "Microcystis", "Microcystin LR", "Microcystin LA", "Microcystins", "Microcystin YR", "Microcystin WR", "Microcystin-HtyR", "Microcystin HtYR", "Total microcystins plus nodularins", "Microcystin-HilR", "Microcystin dRR", "Microcystin HiLR", "Microcystin LY", "Dissolved microcystins plus nodularins", "Microcystin dLR", "Microcystin LW")
vars2process<-vars2process[! vars2process %in% params] #remove grab samples from list
vars2process #check if any new varables to inlcude
...
```{r}
abbrev <- "Inorganic carbon"
lagos_name <- "Carbon, total inorganic"
lagos_unit <- "mg/l"
dataset_name <-"Inorganic_carbon"
...
```{r}
data_pH_equilibrated<-data_pH_equilibrated %>% select(-URL)
...
write_csv(data_all, file = "alldata.csv")
