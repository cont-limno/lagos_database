...
data_NO3_test$Converted<-c(data_NO3_test$ResultMeasureValue*data_NO3_test$Conversion) #convert data
...
NO3_temp$CharacteristicName<-"Nitrogen, nitrite (NO2) + nitrate (NO3)"
