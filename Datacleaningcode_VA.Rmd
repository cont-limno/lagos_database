...
unique(data_depth$ResultMeasure.MeasureUnitCode) #checked units #change ft and cm to m
...
data_depth<-resultconvert(dat = data_depth, variable = "Depth", unit = "cm", out_unit = "m", conv_factor = 0.01)
...
data_ammonia<-resultconvert(dat = data_ammonia, variable = "Ammonia", unit = "mg/l", out_unit = "ug/l", conv_factor = 0.7765*1000)
...
data_ammonia<-resultconvert(dat = data_ammonia, variable = "Ammonium", unit = "ueq/L", out_unit = "ug/l", conv_factor = 0.7765)
data_ammonia<-detectconvert(dat = data_ammonia, variable = "Ammonium", unit = "ueq/L", out_unit = "ug/l", conv_factor = 0.7765)
...
unique(temp2$ResultAnalyticalMethod.MethodName)
unique(temp2$ResultAnalyticalMethod.MethodIdentifier) #D3867-04 - nitrite - need to convert using 0.3044*1000 formula for mg/l to ug/l


data_NO2<-resultconvert(dat = data_NO2, variable = "Nitrite", unit = "mg/l", out_unit = "ug/l", conv_factor = 0.3044*1000)
...
alldata_VA<- rbind(data_depth, data_secchi, data_calcium, data_aluminum_total, data_aluminum_dissolved, data_mercury_total, data_mercury_dissolved, data_magnesium, data_selenium_total, data_selenium_dissolved, data_arsenic_total, data_arsenic_dissolved, data_atrazine_dissolved, data_ecoli, data_silica, data_chloride, data_oxygen, data_chl, data_pH, data_temp, data_sulfate, data_turb, data_cond, data_TC, data_TDC, data_alk, data_tss, data_DIP, data_TP, data_TDP, data_TKN, data_tdkn, data_TN, data_TDN, data_ammonia, data_NO3, data_NO2)      
