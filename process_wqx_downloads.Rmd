...
abbrev <- "Atrazine"
lagos_name <- "Atrazine, total"
lagos_unit <- "ug/l"
dataset_name <-"Atrazine_total"
...
# saveRDS(data_all, "limnoUS.rds")

#saveRDS(data_all, "atrazine_data.rds") #use as templates
#write_csv(data_all, "atrazine_data.csv")

# write_csv(data_all, file = "all_data_june30.csv")
