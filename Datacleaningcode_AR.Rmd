...
ARdatPull<-read.csv("~~/Lagos Limno/AR_alldata_1975_to_2020.csv")
...
data<- ARdatPull[ARdatPull$CharacteristicName %notin% remove_params$Unique.parameters,]
